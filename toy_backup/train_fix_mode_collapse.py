...
def generate_image(true_dist, epoch):
    ...
    plt.savefig(f"fix_mode_collapse/discriminator_{epoch:08d}.png", figsize=(8, 8))
    plt.close()
...
def train_classifier():
    ...
    for epoch in range(100):
        ...
        if epoch % 10 == 0:
            ...
            ax = plt.gca()
            ax.set_aspect("equal")
            plt.savefig(f"fix_mode_collapse/classifier_{epoch:03d}.png", figsize=(8, 8))
            plt.close()
            ...
            ax = plt.gca()
            ax.set_aspect("equal")
            plt.savefig(f"fix_mode_collapse/confidence_{epoch:03d}.png", figsize=(8, 8))
            plt.close()
...
def train(epoch):
    ...
    ax = plt.gca()
    ax.set_aspect("equal")
    plt.savefig(f"fix_mode_collapse/generator_{epoch:08d}.png", figsize=(8, 8))
    plt.close()
    ...
    ax = plt.gca()
    ax.set_aspect("equal")
    plt.savefig(f"fix_mode_collapse/classifier_{epoch:08d}.png", figsize=(8, 8))
    plt.close()
    ...
    ax = plt.gca()
    ax.set_aspect("equal")
    plt.savefig(f"fix_mode_collapse/confidence_{epoch:08d}.png", figsize=(8, 8))
    plt.close()
